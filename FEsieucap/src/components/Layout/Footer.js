      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-red-500">Red Ribbon Life</h3>
            <p className="text-gray-400">
              Hỗ trợ và đồng hành cùng bệnh nhân HIV/AIDS trong hành trình điều trị và chăm sóc sức khỏe.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Red Ribbon Life. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
